...
export function StaticFeaturedVillageHero({
  dictionary,
    ...
    <section className="relative bg-[url('/new_hero2.png')] bg-cover bg-center shadow-lg py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-15">
        ...
        <svg className="h-full w-full" viewBox="0 0 800 800">
          <defs>
            <pattern id="event-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
              <rect x="0" y="0" width="4" height="4" fill="currentColor" />
            </pattern>
          </defs>
          <rect width="800" height="800" fill="url(#event-pattern)" />
        </svg>
      </div>
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              {dictionary.villages.heroDescription ||
